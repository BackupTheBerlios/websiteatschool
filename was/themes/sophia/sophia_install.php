 ...
 *
 * This file contains the sophia theme installer.
 ...
 * @version $Id: sophia_install.php,v 1.3 2013/06/11 11:25:55 pfokker Exp $
 */
    ...
    $properties = array(
        ...
        array(
            ...
            'fields' => array(
                ...
                'name' => 'stylesheet',
                'type' => 's',
                'value' => 'program/themes/sophia/style.css',
                'sort_order' => 80,
                'extra' => 'maxlength=255',
 ...
 * Note that this minimalistic 'sophia' theme does not need any
 ...
 * etcetera.
 *
 * Note that it is the responsabilty of the caller to correctly store
 ...
 * @return bool TRUE on success + output via $messages, FALSE otherwise
 */
function sophia_upgrade(&$messages,$theme_id) {
    $retval = TRUE;
 ...
 * @return bool TRUE on success + output via $messages, FALSE otherwise
 */
function sophia_uninstall(&$messages,$theme_id) {
    return TRUE;
} // sophia_uninstall()
...
function sophia_demodata(&$messages,$theme_id,$config,$manifest) {
    ...
    $settings = array(
        ...
        'style'                  => sprintf("#navigation ul li { background-image:  url('%s/themes/%s/stencil0.png'); }\n".
                                            "#navigation ul li.navigation_button5 { background-color: #FF3399; }\n",
                                            $progwww, $theme_name),
        'header_text'            => $slogan,
        'left_top_html'          => sprintf("<img src=\"%s/themes/%s/calendula.jpg\" width=\"120\" height=\"90\" alt=\"\">\n",
                                            $progwww, $theme_name),
