 ...
 * @package waslang_fr
 * @version $Id: frugal.php,v 1.5 2013/06/14 20:00:16 pfokker Exp $
 */
...
$string['show_breadcrumb_trail_option'] = 'Montrer le fil d\'~Ariane';
$string['stylesheet_label'] = 'Feuille de st~yle statique';
$string['stylesheet_title'] = 'URL du fichier de feuille de style statique (vide pour aucune)';
$string['style_usage_static_label'] = 'Utiliser la feuille de style statique';
$string['style_usage_static_option'] = 'Utiliser le fichier de feuille de style stati~que';
$string['style_usage_static_title'] = 'Cocher la case pour inclure la feuille de style statique sur chaque page';
...
$string['style_usage_area_label'] = 'Utiliser le style Extra (zone)';
$string['style_usage_area_option'] = 'Utiliser le style extra au niveau de la ~zone';
$string['style_usage_area_title'] = 'Ceci applique l\'information de style depuis le style \'Extra\' ci-dessus';
$string['style_usage_node_label'] = 'Utiliser le style extra (nœud)';
