 ...
 * @version $Id: mypage.php,v 1.1 2011/02/01 13:01:36 pfokker Exp $
 */
if (!defined('WASENTRY')) { die('no entry'); }

$string['title'] = 'My Personal Page';
$string['description'] = 'This module handles the MyPage feature, a personalised page and login-box';
