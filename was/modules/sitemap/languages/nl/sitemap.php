 ...
 * @version $Id: sitemap.php,v 1.3 2012/04/18 07:57:28 pfokker Exp $
 */
if (!defined('WASENTRY')) { die('no entry'); }

$string['title'] = 'Sitemap';
$string['description'] = 'Deze module geeft een eenvoudig, beperkt of uitgebreid overzicht van de website';
...
$string['sitemap_available_areas'] = 'Beschikbare gebieden';
