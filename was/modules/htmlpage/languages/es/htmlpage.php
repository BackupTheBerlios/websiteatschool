 ...
 * @package waslang_es
 * @version $Id: htmlpage.php,v 1.4 2011/09/30 13:22:51 pfokker Exp $
 */
if (!defined('WASENTRY')) { die('no entry'); }
$string['title'] = 'Página-HTML llana';
$string['description'] = 'Este módulo trata las páginas-HTML llanas, sin más';
$string['translatetool_title'] = 'Página-HTML';
$string['translatetool_description'] = 'Este archivo contiene traducciones para el módulo de la página-HTML llana';
?>