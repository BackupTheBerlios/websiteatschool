 ...
 * @package waslang_fr
 * @version $Id: htmlpage.php,v 1.1 2011/05/04 14:22:11 pfokker Exp $
 */
if (!defined('WASENTRY')) { die('no entry'); }
$string['title'] = 'Page en HTML brut';
$string['description'] = 'Ce module traite des pages en HTML brut, sans clochettes ni sifflets…';
$string['translatetool_title'] = 'Page HTML';
$string['translatetool_description'] = 'Ce fichier contient les traductions pour le module Pages en HTML brut';
?>