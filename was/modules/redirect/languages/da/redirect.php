...
$string['link_href_title'] = 'Indtast hele den eksterne hjemmesides URL\'s for at linke til den';
$string['link_target'] = '~Mål';
$string['link_target_title'] = 'Indtast målet, f.eks. _ blank for et nyt vindue ( se manual)';
?>