...
$string['link_href'] = '~آدرس کامل';
$string['link_href_title'] = 'وارد کنید آدرس کامل خارجی توی صفحه ای که لینک به';
$string['link_target'] = '~هدف';
$string['link_target_title'] = 'هدف را وارد کنید، مثلاً _blank برای یك پنجره جدید (دستی)';
?>