...
$string['link_href_title'] = 'Inserir URL completo da página externa para interligar a';
$string['link_target'] = '~Objetivo';
$string['link_target_title'] = 'Inserir objetivo, ex.: _nova janela vazia (ver manual)';
?>