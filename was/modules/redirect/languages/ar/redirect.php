 ...
 * @version $Id: redirect.php,v 1.2 2013/06/11 11:25:26 pfokker Exp $
 */
...
$string['link_href_title'] = 'أدخل عنوان الكامل لصفحة على شبكة الإنترنت لربط خارجيURLأدخل عنوان';
$string['link_target'] = '~ الهدف';
$string['link_target_title'] = 'دخول الهدف، على سبيل المثال. فارغة_للنافذة جديدة (انظر الدليل)';
?>