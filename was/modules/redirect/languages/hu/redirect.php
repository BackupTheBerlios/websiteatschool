...
$string['link_href_title'] = 'Adja meg a hivatkozni kívánt weblap teljes URL-jét';
$string['link_target'] = '~Cél';
$string['link_target_title'] = 'Adja meg a célhelyet, például _blank ha új ablak (lásd manuál)';
?>