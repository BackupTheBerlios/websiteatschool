 ...
 * @version $Id: redirect.php,v 1.2 2013/06/11 11:25:27 pfokker Exp $
 */
...
$string['link_href_title'] = 'Entrar el URL completo de la página web externo para enlazar a';
$string['link_target'] = '~Objetivo';
$string['link_target_title'] = 'Entrar el objetivo, pe. _blanco para abrir una nueva ventana (ver manual)';
?>