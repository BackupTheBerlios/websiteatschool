 ...
 * @version $Id: redirect.php,v 1.2 2013/06/11 11:25:29 pfokker Exp $
 */
...
$string['link_href'] = 'UR~L';
$string['link_href_title'] = 'Podaj pełny URL zewnętrznej witryny w lince do niej';
$string['link_target'] = '~Okno';
$string['link_target_title'] = 'Podaj rodzaj okna, n.p. _blank dla nowego okna (patrz podręcznik)';
?>