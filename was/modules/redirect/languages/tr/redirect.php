...
$string['link_href_title'] = 'Harici bir bağlantı için web sayfasının tam URL\'ini girin';
$string['link_target'] = 'A~maç';
$string['link_target_title'] = 'Hedefi girin, örneğin   yeni bir pencere için _boşluk (kılavuza bakın)';
?>