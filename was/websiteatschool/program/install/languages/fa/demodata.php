...
$string['translatetool_description'] = 'این فایل حاوی ترجمه از تظاهرات داده ها';
$string['error'] = 'خطا در داده های نمایشی.';
$string['groupname_faculty'] = 'دانشكده';
$string['full_name_faculty'] = 'عضو ستاد';
$string['groupname_team'] = 'تيم';
$string['full_name_team'] = 'تمام کارمندان';
$string['groupname_seniors'] = 'سالمندان';
$string['full_name_seniors'] = 'از شاگردان كلاس 5 تا 8';
$string['groupname_juniors'] = 'نوجوانان';
$string['full_name_juniors'] = 'از شاگردان كلاس 1 تا 4';
$string['public_area_title'] = 'تمثيل دبستان';
$string['private_area_title'] = '(تمثيل';
$string['extra_area_title'] = 'تمثيل غیر فعال';
$string['public_area_path'] = 'تمثيل';
$string['private_area_path'] = 'intranet';
$string['extra_area_path'] = 'غیر فعال';
$string['alerts_initial_load'] = 'نمایشی از نصب اوليه داده ها، از جمله اين پيام آزمايش.';
$string['alerts_every_1440_minutes'] = 'دريافت خواهيد کرد در يک هشدار يکبار بيشتر هر سال 1440دقیقه (1 روز).';
$string['alerts_every_60_minutes'] = 'دريافت خواهيد کرد هشدار داد در هر 60 دقيقه يك بار بيشتر (1 ساعت).';
$string['alerts_email_address'] = 'هشدارهای سربستهاي خواهد بود به این آدرس:';
$string['alerts_all_areas'] = 'هشدارهای جدی خواهد شد دامن زدن به يك تغيير در هر منطقه است.';
$string['alerts_private_area'] = 'هشدارهای امنیتی تنها خواهد شد ارسال شود (برای تغییرات در';
$string['welcome_title'] = 'به وب سايت ما خوش آمديد';
$string['welcome_link_text'] = 'خوش آمدید';
$string['schoolinfo_title'] = 'اين بخش حاوی اطلاعات مدرسه';
$string['schoolinfo_link_text'] = 'اطلاعات مدرسه';
...
$string['latestnews_link_text'] = 'آخرین اخبار';
$string['latestnewsletter_title'] = 'اين آخرين شماره خبرنامه ما';
$string['latestnewsletter_link_text'] = 'خبرنامه';
$string['newsarchive_title'] = 'اين بخش شامل اخبار و خبرنامه آرشيو';
$string['newsarchive_link_text'] = 'آرشيو';
$string['oldnews_title'] = 'خبر قديمي ام.';
$string['oldnews_link_text'] = 'خبر قديمي';
$string['oldnewsletters_title'] = 'بزرگتر از مسائل ما خبرنامه';
$string['oldnewsletters_link_text'] = 'سااله پير';
$string['search_title'] = 'در اینجا شما می توانید جستجو سايت ما';
$string['search_link_text'] = 'جستجو';
$string['searchbox_title'] = 'سايت ما جستجو';
$string['searchbox_link_text'] = 'جستجو';
$string['sitemap_title'] = 'نمای کلی از سايت';
$string['sitemap_link_text'] = 'نقشه سايت';
$string['mypage_title'] = 'ورود/خروج از سیستم و منوی پرش';
$string['mypage_link_text'] = 'من صفحه';
$string['quicktop_title'] = 'لینک دائم در صدر';
$string['quicktop_link_text'] = 'خیلی سریع (لینک بالا)';
$string['about_title'] = 'در مکتب ما';
$string['about_link_text'] = 'در مورد';
$string['contact_title'] = 'نحوه تماس با ما';
$string['contact_link_text'] = 'تماس با';
$string['quickbottom_title'] = 'لینک دائم در ته';
$string['quickbottom_link_text'] = '(خیلی فوری لینک پایین)';
$string['disclaimer_title'] = 'سلب مسئولیت زیر ذکر شده باشد';
$string['disclaimer_link_text'] = 'سلب مسئولیت زیر ذکر شده باشد';
$string['login_title'] = 'استفاده از این لینک برای ورود به سیستم';
$string['login_link_text'] = 'ورود به سیستم';
$string['intranet_title'] = 'خوش آمدید  intranet   به';
$string['intranet_link_text'] = 'Intranet';
$string['meetings_title'] = 'اين بخش برگزار می شود نشست نتایج و در دقیقه';
...
$string['minutes2_link_text'] = 'پاييز';
$string['minutes3_title'] = 'دقیقه از سومين نشست';
$string['minutes3_link_text'] = 'زمستان';
$string['minutes4_title'] = 'دقیقه از جلسه چهارم';
