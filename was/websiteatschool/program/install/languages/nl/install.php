...
/** /program/install/languages/nl/install.php - translated messages for /program/install.php (Dutch)
 *
 ...
 * @package wasinstall
 * @version $Id: install.php,v 1.6 2013/06/11 11:26:02 pfokker Exp $
 */
...
$string['language_name'] = 'Nederlands';
...
$string['cms_datadir_help'] = 
'Dit is de directory die uploadbestanden en andere gegevensbestanden bevat. Het is erg belangrijk dat deze directory zich buiten de zogenaamde Document Root bevindt, dat wil zeggen: deze directory moet niet van buitenaf toegankelijk zijn met een browser. Merk op dat de webserver voldoende permissies moet hebben om in deze datadirectory bestanden en subdirectories te lezen, schrijven en aan te maken. Voorbeelden: <strong>/home/httpd/wasdata</strong> of <strong>C:\\Program Files\\Apache Group\\Apache\\wasdata</strong>.';
...
$string['dialog_confirm_explanation'] = 
'U staat op het punt om uw nieuwe website te installeren. Controleer onderstaande configuratiegegevens zorgvuldig en druk daarna op [Volgende] om het installatieproces daadwerkelijk te starten. De installatie kan enige tijd duren.';
