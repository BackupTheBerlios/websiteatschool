 ...
 * @package wasinstall
 * @version $Id: install.php,v 1.20 2013/07/10 06:30:50 pfokker Exp $
...
//        }
    ...
    function button($button) {
        return sprintf('<input type="submit" name="button_%s" value="%s" accesskey="%s" title="%s" class="button button_%s">',
                       $button,
                       $this->t($button),
